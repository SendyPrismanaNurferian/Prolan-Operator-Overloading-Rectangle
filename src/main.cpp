...
int main()
{
    ...
    cout << "Allert 'Anda boleh menggunakan atau coding ini dijadikan sebagai referensi, namun tidak boleh keras mencopas atau mengganti tanpa seizin pemilik. By Sendy'";
    cin.ignore();
    system("cls||clear");
